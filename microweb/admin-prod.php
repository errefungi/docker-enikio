                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="actualizarProducto.php" method="post">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="formlabel">Id de este producto</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="inventario" class="form-control" id="inventario" aria-describedby="emailHelp">
                                            </div>
