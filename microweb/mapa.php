...
$servurl = "http://aptos:3002/aptos/coords/$universidad";
$servurl2 = "http://aptos:3002/coords";
...
curl_setopt($ch, CURLOPT_URL, "http://aptos:3002/coords"); // establece la URL
...
<body>
  ...
  <script type="text/javascript">
    ...
    var markerU = L.marker([<?php echo $latU ?>, <?php echo $longU ?>], {
      icon: redIcon
    }).addTo(map);
